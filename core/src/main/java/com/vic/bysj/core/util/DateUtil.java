package com.vic.bysj.core.util;

/**
 * 时间工具类
 * Created by vic
 * Create time : 2017/2/5 下午5:48
 */
...
//    }
    ...
    public static Date getCurrentDate() {
        return DateUtil.setDate(new Date(), null, null, null, 0);
    }
...
//        //部分法定节假日期，配置成系统参数
//        //{"0101", "0102", "0103", "0207", "0208", "0209", "0210", "0211", "0212", "0213", "1001", "1002", "1003", "1004", "1005", "1006", "1007"};
//        Set<String> holidays = SysParam.INSTANCE.HOLIDAYS;
//        String sDate = DateUtil.format(date, DateUtil.DATE_FORMAT_MONTH_DAY2);
//        if (!CollectionUtil.isEmpty(holidays) && holidays.contains(sDate)) {
//            //是节假日
//            isHoliday = true;
//        }
//        return isHoliday;
//    }
    ...
    public static Date getCustomWeekDate(Date date, Integer type) {
        ...
        if (type == 0) {
            if (week != 7) {
                date = DateUtil.addDate(date, Calendar.DATE, -week);
            }
        } else if (type == 1) {
            if (week != 6) {
                date = DateUtil.addDate(date, Calendar.DATE, week == 7 ? week - 1 : 6 - week);
            }
        }
        return date;
    }
...
//        Assert.notNull(date, "date is null!");
    ...
    public static void main(String[] args) {
        ...
        System.out.print(DateUtil.getField(new Date(), 0));

//        System.out.print(currentTimePlusMinutes(20L));
//        try {
//            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
//            Date now = new Date();
//            Date yesterday = getDayBefore(now);
////            Date now = sdf.parse("2015-06-19 19:50:00");
////            Date end = sdf.parse("2015-06-19 19:51:12");
////            Integer t = diffMinutes(now, end);
//            System.out.println(sdf.format(addDate(yesterday, Calendar.HOUR_OF_DAY,2)));
//        }catch (Exception e){
//         e.printStackTrace();
//        }
